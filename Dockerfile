...
RUN choco upgrade chocolatey && choco install --no-progress -y 7zip git python2 sed curl windows-sdk-10-version-2004-all cmake --installargs 'ADD_CMAKE_TO_PATH=System'
RUN sed -h
RUN cmake -h
